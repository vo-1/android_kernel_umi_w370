...
#ifdef CONFIG_COMPAT
#define COMPAT_QMC6983_SET_RANGE		_IOW(QMC6983_IOCTL_BASE, 1, compat_int_t)
#define COMPAT_QMC6983_SET_MODE		_IOW(QMC6983_IOCTL_BASE, 2, compat_int_t)
#define COMPAT_QMC6983_SET_BANDWIDTH	_IOW(QMC6983_IOCTL_BASE, 3, compat_int_t)
#define COMPAT_QMC6983_READ_MAGN_XYZ	_IOR(QMC6983_IOCTL_BASE, 4, compat_int_t)	
#define COMPAT_QMC6983_SET_REGISTER_A	_IOW(QMC6983_IOCTL_BASE, 5, compat_uptr_t)
#define COMPAT_QMC6983_SELF_TEST	   _IOWR(QMC6983_IOCTL_BASE, 6, compat_uptr_t)
#endif
