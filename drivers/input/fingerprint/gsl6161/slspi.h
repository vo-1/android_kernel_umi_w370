...
#define 	GPIO_INT_PIN 		(GPIO1 | 0x80000000)
#define 	GPIO_SPI_EINT_PIN_M_GPIO   GPIO_MODE_00
#define 	GPIO_SPI_EINT_PIN_M_EINT   GPIO_MODE_00
#define   GPIO_FINGERPRINT_EINT_PIN  GPIO_INT_PIN

#define 	GPIO_RST_PIN		(GPIO7 | 0x80000000)
...
#define SPI_SPEED			(1 * 1000 * 1000) //(8 * 1024 * 1024) //origin
#define SPI_BITS				8
#define SPI_DELAY			0
#define SPI_BUF_SIZE	 4096	
//Singh_start
//#define LSB_TO_MSB   //origin open 
//#define SILEAD_IRQ	//origin close
...
#define FP_ERR(fmt, args...)
#endif
#define CUST_EINT_FINGER_NUM GPIO_IRQ_NUM //GPIO_FINGERPRINT_EINT_PIN 
//Singh_end
struct spidev_data {
    dev_t			devt;
    spinlock_t		spi_lock;
